#!/usr/bin/env bash
# VM-B: 6 sampled pruned runs
#   sampled independent: 0.75,0.5,0.25,0.1   sampled nested: 0.75,0.5
#   (remaining sampled nested 0.25,0.1 go on VM-A)
set -u
...
RUNS=(
  "sampled:random:0.75" "sampled:random:0.5" "sampled:random:0.25" "sampled:random:0.1"
  "sampled:nested_random:0.75" "sampled:nested_random:0.5"
)
